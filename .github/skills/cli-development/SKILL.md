...
description: "Add, modify, or debug CLI flags and commands for nanvix-copilot. Use when: adding new CLI options, changing argument parsing, updating help text, fixing CLI validation, or modifying how flags are consumed downstream."
---
