---
name: testing
description: "Write, run, or debug tests for nanvix-copilot. Use when: adding unit tests, fixing test failures, extending test coverage, writing test cases for CLI parsing, encoding, runtime detection, or any new module."
---
